...
const refundEvidenceInput = document.querySelector("#refundEvidenceInput");
const refundUploadList = document.querySelector("#refundUploadList");
const refundUploadError = document.querySelector("#refundUploadError");
