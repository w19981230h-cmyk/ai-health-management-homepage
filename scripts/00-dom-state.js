...
const purchaseQuantityMinus = document.querySelector("#purchaseQuantityMinus");
const purchaseQuantityPlus = document.querySelector("#purchaseQuantityPlus");
const purchaseQuantityInput = document.querySelector("#purchaseQuantityInput");
